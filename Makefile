# This Makefile is for the File::Navigate extension to perl.
#
...
#     ABSTRACT_FROM => q[Navigate.pm]
#     AUTHOR => q[A. U. Thor <a.u.thor@a.galaxy.far.far.away>]
#     NAME => q[File::Navigate]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[Navigate.pm]
...
FULLEXT = File/Navigate
BASEEXT = Navigate
PARENT_NAME = File
DLBASE = $(BASEEXT)
VERSION_FROM = Navigate.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = Navigate.pm

PM_TO_BLIB = Navigate.pm \
	$(INST_LIB)/File/Navigate.pm
...
DISTNAME = File-Navigate
DISTVNAME = File-Navigate-1.0
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  Navigate.pm $(INST_MAN3DIR)/File::Navigate.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         File-Navigate' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      1.0' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: Navigate.pm' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Navigate freely inside a text file</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>A. U. Thor &lt;a.u.thor@a.galaxy.far.far.away&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  Navigate.pm $(INST_LIB)/File/Navigate.pm 
